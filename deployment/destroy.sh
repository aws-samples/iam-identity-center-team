...
appId=`aws amplify list-apps --region $REGION --output json | jq -r '.apps[] | select(.name=="TEAM-IDC-APP-V2") | .appId' `
...
aws cloudformation delete-stack --region $REGION --stack-name TEAM-IDC-APP-V2
