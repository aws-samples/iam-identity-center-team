...
const { AWS_APP_ID, AWS_BRANCH, SSO_LOGIN, TEAM_ADMIN_GROUP, TEAM_AUDITOR_GROUP, TAGS, CLOUDTRAIL_AUDIT_LOGS, TEAM_ACCOUNT, AMPLIFY_CUSTOM_DOMAIN, DISABLE_LANDING_PAGE } = process.env;
...
async function update_react_parameters() {
  ...
  reactParametersJson.DisableLandingPage = DISABLE_LANDING_PAGE
